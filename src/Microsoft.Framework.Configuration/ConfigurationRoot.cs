...
namespace Microsoft.Framework.Configuration
{
    public class ConfigurationRoot : IConfigurationRoot
    {
        ...
        public IEnumerable<IConfigurationSection> GetChildren() => GetChildrenAtPath(string.Empty);

        public IEnumerable<IConfigurationSection> GetChildrenAtPath(string path)
        {
